...
export const LOGIN_SCREEN_ASSET_GROUP_BACKGROUND_ENTITY_TYPE = 'login-screen-asset-group-background';
...
export const LOGIN_SCREEN_ASSET_UPLOAD_BACKGROUND_ENTITY_TYPE = 'login-screen-asset-upload-background';
